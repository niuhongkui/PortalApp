	...
	<view class="container">
		...
		<view class="c-list">
			<view class="c-row b-b" @click="toggleSpec">
				...
				<view class="con">
					<text class="selected-text">{{ specSelected.Name }}</text>
				</view>
		...
		<view class="page-bottom">
			...
			<view class="p-b-btn"><text class="yticon "></text></view>
			...
			<view class="layer attr-content" @click.stop="stopPrevent">
				...
				<view class="attr-list">
					...
					<view class="item-list">
						<text v-for="(childItem, childIndex) in specChildList" :key="childIndex" class="tit" :class="{ selected: childItem.ID == specSelected.ID }"
		...
		onLoad(options) {
			...
			this.$api.ajax({
				...
				success: function(json) {
					...
					if (good.SpecList.length > 0) ths.specSelected = good.SpecList[0];
					if (ths.hasLogin) {
						ths.$api.ajax({
							url: '/api/order/IsFavorite/' + ths.id,
							success: function(json) {
								var res = json.data;
