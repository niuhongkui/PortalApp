    ...
    <view>
        ...
        <view class="yt-list">
            <view class="yt-list-cell b-b">
                ...
                <picker class="cell-tip" mode="multiSelector" @columnchange="bindMultiPickerColumnChange" :value="multiIndex" :range="multiArray">
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            var addr = ths.addressData.Province + ths.addressData.City + ths.addressData.County + ths.addressData.DetailAddr + ths.addressData.Addressee;
            ths.$api.ajax({
